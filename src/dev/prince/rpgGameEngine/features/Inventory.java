...
//		}
	...
	public void render(){
		...
		TextArea.renderTextArea(handler.getWidth()/2-Fonts.fontBig.getWidth(title)/2, y-TextArea.getyOffset()*2-Fonts.fontBig.getHeight("I"), title, Color.white, new float[]{0,0,0,0}, new float[]{0,0,0,0},true,-1,-1);
...
//		}
		int constX1=10;
		int constX2=width/2+10;
		int constY=10;
		for(InventoryItem item:items){
			item.item.render(x+constX1,y+constY,40,40);
			Renderer.renderString(x+constX2,y+constY,String.valueOf(item.quantity), Color.white, true);
		}
