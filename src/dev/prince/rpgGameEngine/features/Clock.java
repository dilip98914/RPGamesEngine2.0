...
public class Clock {
	...
	public void render(){
		...
		TextArea.renderTextArea(handler.getWidth()-(70 + Fonts.font.getWidth(time)), handler.getHeight()-(10 + Fonts.font.getHeight(time)), time, Color.white, new float[]{0,0,0,0}, new float[]{0,0,0,0},false,-1,-1);
